            ...
            children={
                <>
                    <label className="popup__form-label sign__form-label">
                        <input type="text" className="popup__input sign__input" value={email || ''} onChange={handleChangeEmail} name="Email" placeholder="Email" required
                            minLength="2" maxLength="40" id="Email-input" />
                        <span className="popup__input-error Email-input-error">1</span>
                    </label>
                    <label className="popup__form-label sign__form-label">
                        <input type="text" className="popup__input sign__input" value={password || ''} onChange={hanldeChangePassword} name="password" placeholder="Пароль"
